...
<?php
    $sum_check = $galery[0][1] + $foto1 + $foto2 + $foto3 + $foto4 + $foto5 + $foto6 + $foto7 + $foto8 + $foto9;
    echo $sum_check .' sum check <br>';
    echo $sum_vyr .' vyr <br>';
    echo $sum_mot .' mot <br>';
    
if(($galery[0][0]==1 || $galery[0][0]==3 || $galery[0][0]==8 || $galery[0][0]==9 || $galery[0][0]==10)&&($sum_vyr == $sum_check)){
    echo '<h3 class="green">ESI ŽMOGUS</h3>';
}
elseif(($galery[0][0]==2 || $galery[0][0]==4 || $galery[0][0]==5 || $galery[0][0]==6 || $galery[0][0]==7)&&($sum_mot == $sum_check)){
    echo '<h3 class="green">ESI ŽMOGUS</h3>';
}
